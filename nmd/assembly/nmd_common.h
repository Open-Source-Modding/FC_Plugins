...
extern NMD_ASSEMBLY_API const char* const _nmd_reg8[8];
extern NMD_ASSEMBLY_API const char* const _nmd_reg8_x64[8];
extern NMD_ASSEMBLY_API const char* const _nmd_reg16[8];
extern NMD_ASSEMBLY_API const char* const _nmd_reg32[8];
extern NMD_ASSEMBLY_API const char* const _nmd_reg64[8];
extern NMD_ASSEMBLY_API const char* const _nmd_regrxb[8];
extern NMD_ASSEMBLY_API const char* const _nmd_regrxw[8];
extern NMD_ASSEMBLY_API const char* const _nmd_regrxd[8];
extern NMD_ASSEMBLY_API const char* const _nmd_regrx[8];
extern NMD_ASSEMBLY_API const char* const _nmd_segment_reg[6];

extern NMD_ASSEMBLY_API const char* const _nmd_condition_suffixes[16];

extern NMD_ASSEMBLY_API const char* const _nmd_op1_opcode_map_mnemonics[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp1[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp2[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp3[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp5[7];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp6[6];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7_reg0[6];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7_reg1[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7_reg2[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7_reg3[8];
extern NMD_ASSEMBLY_API const char* const _nmd_opcode_extensions_grp7_reg7[6];

extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesD8[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesD9[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesDA_DE[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesDB[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesDC[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesDD[8];
extern NMD_ASSEMBLY_API const char* const _nmd_escape_opcodesDF[8];
extern NMD_ASSEMBLY_API const char* const* _nmd_escape_opcodes[8];

extern NMD_ASSEMBLY_API const uint8_t _nmd_op1_modrm[16];
extern NMD_ASSEMBLY_API const uint8_t _nmd_op1_imm8[13];
extern NMD_ASSEMBLY_API const uint8_t _nmd_op1_imm32[7];
extern NMD_ASSEMBLY_API const uint8_t _nmd_invalid_op2[7];
extern NMD_ASSEMBLY_API const uint8_t _nmd_two_opcodes[6];
extern NMD_ASSEMBLY_API const uint8_t _nmd_valid_3DNow_opcodes[24];
